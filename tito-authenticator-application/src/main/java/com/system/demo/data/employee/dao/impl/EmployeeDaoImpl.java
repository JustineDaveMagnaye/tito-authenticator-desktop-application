...
public class EmployeeDaoImpl implements EmployeeDao {
    ...
    public boolean addEmployee(Employee employee) {
        try (Connection connection = ConnectionHelper.getConnection()){
            ...
            stmt.setTimestamp(4, employee.getDateEmployed());
            stmt.setTimestamp(5, employee.getBirthdate());
            stmt.setString(6, employee.getBirthplace());
            stmt.setString(7, employee.getSex());
            stmt.setString(8, employee.getAddress());
            stmt.setString(9, employee.getContactNo());
            stmt.setString(10, employee.getCivilStatus());
            stmt.setString(11, employee.getCitizenship());
            stmt.setString(12, employee.getReligion());
            stmt.setString(13, employee.getEmail());
            stmt.setString(14, employee.getSssNo());
            stmt.setString(15, employee.getTinNo());
            stmt.setString(16, employee.getPagibigNo());
            stmt.setString(17, employee.getEmployeeNo());
    ...
    public boolean updateEmployee(Employee employee) {
        try (Connection connection = ConnectionHelper.getConnection()){
            ...
            stmt.setString(18, employee.getLoginId());
    ...
    private Employee setEmployee(ResultSet rs) {
        try {
            ...
            employee.setLoginId(rs.getString("login_id"));
